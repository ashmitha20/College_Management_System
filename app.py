...
def add_faculty():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            db.add_faculty(name, dob, address, sex, blood_group, email, contact, alternate_contact)
...
def update_faculty(id):
    ...
    if request.method == 'POST':
        ...
        try:
            db.update_faculty(id, name, dob, address, sex, blood_group, email, contact, alternate_contact)
...
def add_students():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            db.add_students(name, dob, address, sex, blood_group, email, contact, alternate_contact)
...
def add_lab_staff():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Insert faculty to DB
            db.add_lab_staff(name, dob, address, sex, blood_group, email, contact, alternate_contact)
...
def add_office_staff():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Insert faculty to DB
            db.add_office_staff(name, dob, address, sex, blood_group, email, contact, alternate_contact)
